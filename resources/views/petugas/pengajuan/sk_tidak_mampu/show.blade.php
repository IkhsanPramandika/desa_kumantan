...
@section('content')
<h1 class="h3 mb-4 text-gray-800">Detail Permohonan Surat Keterangan Tidak Mampu #{{ $permohonan->id }}</h1>
    ...
    <div class="col-lg-5">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('petugas.permohonan-sk-tidak-mampu.index') }}" class="btn btn-secondary btn-block mt-3"><i class="fas fa-arrow-left"></i> Kembali ke Daftar</a>
            </div>
        </div>
