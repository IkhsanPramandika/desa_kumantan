...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Form Data Anak dan Orang Tua</h6>
    </div>
    <div class="card-body">
        {{-- PERBAIKAN: Nama rute disesuaikan menjadi '.selesaikan' --}}
        <form action="{{ route('petugas.permohonan-sk-kelahiran.selesaikan', $permohonan->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                @error('tempat_lahir_anak')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            ...
            <div class="form-group">
                ...
                @error('tanggal_lahir_anak')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
           ...
           <div class="form-group">
                ...
                @error('agama_anak')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            ...
            <div class="form-group">
                ...
                @error('alamat_anak')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            ...
            <div class="form-group">
                ...
                @error('no_buku_nikah')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>

            <button type="submit" class="btn btn-primary">Simpan Data & Buat Surat</button>
            <a href="{{ route('petugas.permohonan-sk-kelahiran.index') }}" class="btn btn-secondary">Batal</a>
        </form>
    </div>
</div>
@endsection
