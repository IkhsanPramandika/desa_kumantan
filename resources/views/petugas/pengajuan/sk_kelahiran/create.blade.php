...
@section('title', 'Ajukan Permohonan Surat Keterangan Kelahiran')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Ajukan Permohonan Surat Keterangan Kelahiran Dan Proses Akta Kelahiran</h1>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('permohonan-sk-kelahiran.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <label for="file_ktp_input">File KTP Orang Tua</label>
            ...
            {{-- Custom Upload Input for surat_nikah_orangtua --}}
            <div class="form-group">
                <label for="surat_nikah_orangtua_input">File Surat Nikah Orang Tua</label>
                <div class="custom-file-upload-container @error('surat_nikah_orangtua') is-invalid-custom @enderror" id="drop_area_surat_nikah_orangtua">
                    <input type="file" class="d-none" id="surat_nikah_orangtua_input" name="surat_nikah_orangtua" accept=".pdf,.jpg,.jpeg,.png">
                    <button type="button" class="btn btn-primary btn-sm" id="upload_button_surat_nikah_orangtua">Upload</button>
                    <span class="text-muted ml-2 file-placeholder" id="surat_nikah_orangtua_placeholder">Drag & Drop Files</span>
                    <span class="file-name ml-2 text-muted" id="surat_nikah_orangtua_name"></span>
                </div>
                <small class="form-text text-muted">Jenis Ekstensi yang diizinkan adalah jpg, jpeg, png, pdf</small>
                <small class="form-text text-muted">Ukuran maksimal 2MB.</small>
                @error('surat_nikah_orangtua')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
            </div>

            {{-- Custom Upload Input for surat_keterangan_kelahiran --}}
            <div class="form-group">
                <label for="surat_keterangan_kelahiran_input">File Surat Keterangan Kelahiran (dari Bidan/RS)</label>
                <div class="custom-file-upload-container @error('surat_keterangan_kelahiran') is-invalid-custom @enderror" id="drop_area_surat_keterangan_kelahiran">
                    <input type="file" class="d-none" id="surat_keterangan_kelahiran_input" name="surat_keterangan_kelahiran" accept=".pdf,.jpg,.jpeg,.png">
                    <button type="button" class="btn btn-primary btn-sm" id="upload_button_surat_keterangan_kelahiran">Upload</button>
                    <span class="text-muted ml-2 file-placeholder" id="surat_keterangan_kelahiran_placeholder">Drag & Drop Files</span>
                    <span class="file-name ml-2 text-muted" id="surat_keterangan_kelahiran_name"></span>
                </div>
                <small class="form-text text-muted">Jenis Ekstensi yang diizinkan adalah jpg, jpeg, png, pdf</small>
                <small class="form-text text-muted">Ukuran maksimal 2MB.</small>
                @error('surat_keterangan_kelahiran')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
            </div>
