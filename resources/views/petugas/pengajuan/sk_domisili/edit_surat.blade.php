...
@section('content')
<h1 class="h3 mb-4 text-gray-800">Proses & Edit Surat Keterangan Domisili</h1>
    ...
    <div class="col-lg-5">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <p>{{ $permohonan->keperluan_domisili ?? 'Tidak ada keterangan.' }}</p>
            </div>
        </div>
    </div>
        ...
        <form action="{{ route('petugas.permohonan-sk-domisili.selesaikan', $permohonan->id) }}" method="POST">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>NIK Pemohon (jika perorangan)</label>
