...
@section('title', 'Buat Permohonan KK Perubahan Data')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Buat Permohonan Kartu Keluarga Perubahan Data Baru</h1>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="{{ route('permohonan-kk-perubahan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf

            {{-- Custom Upload Input for file_kk --}}
            <div class="form-group">
                <label for="file_kk_input">File Kartu Keluarga (KK) Asli</label>
            ...
            <div class="form-group">
                <label for="file_ktp_input">File KTP Pemohon</label>
            ...
            {{-- Custom Upload Input for surat_keterangan_pendukung --}}
            <div class="form-group">
                <label for="surat_keterangan_pendukung_input">File Surat Keterangan Pendukung (Opsional)</label>
                <div class="custom-file-upload-container @error('surat_keterangan_pendukung') is-invalid-custom @enderror" id="drop_area_surat_keterangan_pendukung">
                    <input type="file" class="d-none" id="surat_keterangan_pendukung_input" name="surat_keterangan_pendukung" accept=".pdf,.jpg,.jpeg,.png">
                    <button type="button" class="btn btn-primary btn-sm" id="upload_button_surat_keterangan_pendukung">Upload</button>
                    <span class="text-muted ml-2 file-placeholder" id="surat_keterangan_pendukung_placeholder">Drag & Drop Files</span>
                    <span class="file-name ml-2 text-muted" id="surat_keterangan_pendukung_name"></span>
                </div>
                <small class="form-text text-muted">Jenis Ekstensi yang diizinkan adalah jpg, jpeg, png, pdf</small>
                <small class="form-text text-muted">Ukuran maksimal 2MB.</small>
                @error('surat_keterangan_pendukung')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
            </div>
            ...
            <a href="{{ route('permohonan-kk-perubahan.index') }}" class="btn btn-secondary">Batal</a>
        </form>
    </div>
</div>
@endsection
