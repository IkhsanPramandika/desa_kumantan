...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('petugas.permohonan-kk-hilang.index') }}" class="btn btn-secondary btn-sm">
...
<div class="row">
    ...
    <div class="col-lg-7">
        ...
        {{-- [UI IMPROVEMENT] Kotak Lampiran yang lebih rapi --}}
        <div class="card shadow mb-4">
            <div class="card-header py-3">
    ...
    <div class="col-lg-5">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                {{-- [UX IMPROVEMENT] Tampilan dinamis berdasarkan status --}}
                ...
                @elseif($permohonan->status == 'selesai')
                    ...
                    <a href="{{ route('petugas.permohonan-kk-hilang.download-final', $permohonan->id) }}" class="btn btn-success btn-block"><i class="fas fa-download"></i> Unduh Dokumen Final</a>
