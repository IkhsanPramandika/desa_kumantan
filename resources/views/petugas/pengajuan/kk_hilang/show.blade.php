...
@section('title', 'Detail & Proses Permohonan KK Hilang')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Detail Permohonan KK Hilang #{{ $permohonan->id }}</h1>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                @if($permohonan->status == 'pending')
                    ...
                    <form action="{{ route('petugas.permohonan-kk-hilang.verifikasi', $permohonan->id) }}" method="POST" class="mb-2">
                        @csrf
                ...
                @elseif($permohonan->status == 'selesai')
                    ...
                    <a href="{{ route('petugas.permohonan-kk-hilang.download-final', $permohonan->id) }}" class="btn btn-success btn-block"><i class="fas fa-download"></i> Unduh KK Final</a>
                ...
                <a href="{{ route('petugas.permohonan-kk-hilang.index') }}" class="btn btn-secondary btn-block mt-3"><i class="fas fa-arrow-left"></i> Kembali ke Daftar</a>
            </div>
        </div>
...
<div class="modal fade" id="tolakModal" tabindex="-1" role="dialog" aria-labelledby="tolakModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('petugas.permohonan-kk-hilang.tolak', $permohonan->id) }}" method="POST">
                @csrf
...
<div class="modal fade" id="selesaikanModal" tabindex="-1" role="dialog" aria-labelledby="selesaikanModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('petugas.permohonan-kk-hilang.selesaikan', $permohonan->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
