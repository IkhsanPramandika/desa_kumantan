...
@section('title', 'Detail Permohonan SK Usaha')

@section('content')
<h1 class="h3 mb-4 text-gray-800">Detail Permohonan Surat Keterangan Usaha #{{ $permohonan->id }}</h1>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-4">Tempat, Tgl Lahir</dt><dd class="col-sm-8">{{ $permohonan->tempat_lahir ?? '-' }}, {{ $permohonan->tanggal_lahir ? $permohonan->tanggal_lahir->format('d F Y') : '-' }}</dd>
            ...
            <div class="card-body">
                ...
                @if($permohonan->status == 'pending')
                 ...
                 @elseif($permohonan->status == 'diterima')
                    ...
                    <a href="{{ route('petugas.permohonan-sk-usaha.edit-surat', $permohonan->id) }}" class="btn btn-primary btn-block mb-2">
                ...
                @elseif($permohonan->status == 'selesai')
                    ...
                    <a href="{{ route('petugas.permohonan-sk-usaha.download-final', $permohonan->id) }}" class="btn btn-success btn-block"><i class="fas fa-download"></i> Unduh Surat</a>
                ...
                <a href="{{ route('petugas.permohonan-sk-usaha.index') }}" class="btn btn-secondary btn-block mt-3"><i class="fas fa-arrow-left"></i> Kembali ke Daftar</a>
            </div>
        </div>
...
<div class="modal fade" id="tolakModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('petugas.permohonan-sk-usaha.tolak', $permohonan->id) }}" method="POST">
                @csrf
