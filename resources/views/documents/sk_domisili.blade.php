        ...
        <div class="isi-surat">
            ...
            <table class="tabel-data">
                <tr>
                    ...
                    <td class="data">{{ strtoupper($permohonan->nama_pemohon_atau_lembaga ?? '[NAMA PEMOHON/LEMBAGA]') }}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="separator">:</td>
                    <td>{{ $permohonan->alamat_lengkap_domisili ?? '[Alamat Lengkap Domisili]' }}, RT {{ $permohonan->rt_domisili ?? '-' }}/RW {{ $permohonan->rw_domisili ?? '-' }}, Desa Kumantan</td>
                </tr>
            </table>
            ...
            <p class="paragraf">Surat Keterangan Domisili ini dibuat untuk keperluan: <strong>{{ $permohonan->keperluan_domisili ?? '[Keperluan Domisili]' }}</strong>.</p>
