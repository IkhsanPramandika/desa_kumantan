        ...
        <div class="isi-surat">
            ...
            <table class="tabel-data">
                <tr>
                    ...
                    <td class="data">{{ strtoupper($permohonan->nama_anak ?? '-') }}</td>
                </tr>
                <tr>
                    <td class="label">Tempat, Tanggal Lahir</td>
                    <td class="separator">:</td>
                    <td>{{ $permohonan->tempat_lahir_anak ?? '-' }}, {{ $permohonan->tanggal_lahir_anak ? \Carbon\Carbon::parse($permohonan->tanggal_lahir_anak)->isoFormat('D MMMM YYYY') : '-' }}</td>
                </tr>
                <tr>
                    <td class="label">Jenis Kelamin</td>
                    <td class="separator">:</td>
                    <td>{{ $permohonan->jenis_kelamin_anak ?? '-' }}</td>
                </tr>
            </table>
