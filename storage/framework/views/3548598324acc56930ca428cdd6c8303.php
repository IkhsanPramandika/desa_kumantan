...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="card card-body mb-4 p-3 bg-light">
            <form action="<?php echo e(route('petugas.permohonan-lainnya.index')); ?>" method="GET">
                <div class="row align-items-end">
                    <div class="col-md-4">
                        <label for="search" class="font-weight-bold">Cari Nama/NIK/Judul</label>
                    ...
                    <div class="col-md-3 d-flex mt-3 mt-md-0">
                        ...
                        <a href="<?php echo e(route('petugas.permohonan-lainnya.index')); ?>" class="btn btn-secondary ml-2" title="Reset Filter"><i class="fas fa-sync"></i></a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><?php echo e(Str::limit($item->judul_permohonan ?? 'N/A', 50)); ?></td>
