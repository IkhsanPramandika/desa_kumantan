        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-4">Tempat, Tgl Lahir</dt><dd class="col-sm-8"><?php echo e($permohonan->masyarakat->tempat_lahir ?? '-'); ?>, <?php echo e($permohonan->masyarakat->tanggal_lahir ? \Carbon\Carbon::parse($permohonan->masyarakat->tanggal_lahir)->isoFormat('D MMMM YYYY') : '-'); ?></dd>
                    <dt class="col-sm-4">Pekerjaan</dt><dd class="col-sm-8"><?php echo e($permohonan->masyarakat->pekerjaan ?? '-'); ?></dd>
                    <dt class="col-sm-4">Alamat</dt><dd class="col-sm-8"><?php echo e($permohonan->masyarakat->alamat_lengkap ?? '-'); ?></dd>
                </dl>
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-4">Tempat, Tgl Lahir</dt><dd class="col-sm-8"><?php echo e($permohonan->tempat_lahir_terkait ?? '-'); ?>, <?php echo e($permohonan->tanggal_lahir_terkait ? \Carbon\Carbon::parse($permohonan->tanggal_lahir_terkait)->isoFormat('D MMMM YYYY') : '-'); ?></dd>
                    <dt class="col-sm-4">Jenis Kelamin</dt><dd class="col-sm-8"><?php echo e($permohonan->jenis_kelamin_terkait ?? '-'); ?></dd>
                    <dt class="col-sm-4">Agama</dt><dd class="col-sm-8"><?php echo e($permohonan->agama_terkait ?? '-'); ?></dd>
                ...
                <dl>
                    ...
                    <dd><?php echo e($permohonan->keperluan_surat ?? '-'); ?></dd>
                    <dt class="mt-2">Catatan Pemohon</dt>
                    <dd><em><?php echo e($permohonan->catatan_pemohon ?? 'Tidak ada catatan.'); ?></em></dd>
                </dl>
            </div>
        </div>
    </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <?php elseif($permohonan->status == 'diterima'): ?>
                    ...
                    <a href="<?php echo e(route('petugas.permohonan-sk-tidak-mampu.edit-surat', $permohonan->id)); ?>" class="btn btn-primary btn-block mb-2">
                ...
                <?php elseif($permohonan->status == 'selesai'): ?>
                    ...
                    <a href="<?php echo e(route('petugas.permohonan-sk-tidak-mampu.download-final', $permohonan->id)); ?>" class="btn btn-success btn-block">
