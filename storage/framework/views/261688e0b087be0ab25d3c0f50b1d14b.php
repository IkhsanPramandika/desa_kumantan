...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="card card-body mb-4 p-3 bg-light">
            <form action="<?php echo e(route('petugas.permohonan-kk-baru.index')); ?>" method="GET">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-3 d-flex mt-3 mt-md-0">
                        ...
                        <a href="<?php echo e(route('petugas.permohonan-kk-baru.index')); ?>" class="btn btn-secondary ml-2" title="Reset Filter"><i class="fas fa-sync"></i></a>
                    </div>
                </div>
            </form>
        </div>
