...
<?php $__env->startSection('title', 'Daftar Permohonan SK Domisili'); ?>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="card card-body mb-4 p-3 bg-light">
            <form action="<?php echo e(route('petugas.permohonan-sk-domisili.index')); ?>" method="GET">
                <div class="row align-items-end">
                    <div class="col-md-4">
                        <label for="search" class="font-weight-bold">Cari Nama/NIK/Lembaga</label>
                    ...
                    <div class="col-md-3 d-flex mt-3 mt-md-0">
                        ...
                        <a href="<?php echo e(route('petugas.permohonan-sk-domisili.index')); ?>" class="btn btn-secondary ml-2" title="Reset Filter"><i class="fas fa-sync"></i></a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <div class="font-weight-bold"><?php echo e($item->nama_pemohon_atau_lembaga ?? 'N/A'); ?></div>
                                <?php if($item->nik_pemohon): ?>
                                <div class="small text-gray-600">NIK: <?php echo e($item->nik_pemohon); ?></div>
                                <?php endif; ?>
                            </td>
                            <td><?php echo e(Str::limit($item->keperluan_domisili, 50) ?? 'N/A'); ?></td>
                            ...
                            <td>
                                <a href="<?php echo e(route('petugas.permohonan-sk-domisili.show', $item->id)); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA\desa_kumantan\desa_kumantan\resources\views/petugas/pengajuan/sk_domisili/index.blade.php ENDPATH**/ ?>