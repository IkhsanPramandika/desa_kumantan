...
<head>
    <meta charset="utf-8">
    <title><?php echo e($permohonan->judul_surat_final); ?></title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="judul-surat">
            ...
            <h4><?php echo e(strtoupper($permohonan->judul_surat_final)); ?></h4>
        </div>
        <div class="nomor-surat">
            Nomor : <?php echo e($permohonan->nomor_surat); ?>
        ...
        <div class="isi-surat">
            ...
            <table class="tabel-data">
                ...
                <tr>
                    ...
                    <td class="data"><?php echo e(strtoupper($permohonan->masyarakat->nama_lengkap ?? '[NAMA LENGKAP TIDAK DITEMUKAN]')); ?></td>
                </tr>
                <tr>
                    <td class="label">NIK</td>
                    <td class="separator">:</td>
                    <td><?php echo e($permohonan->masyarakat->nik ?? '[NIK TIDAK DITEMUKAN]'); ?></td>
                </tr>
                <tr>
                    <td class="label">Tempat/Tgl. Lahir</td>
                    <td class="separator">:</td>
                    <td><?php echo e($permohonan->masyarakat->tempat_lahir ?? ''); ?>, <?php echo e($permohonan->masyarakat->tanggal_lahir ? \Carbon\Carbon::parse($permohonan->masyarakat->tanggal_lahir)->isoFormat('D MMMM YYYY') : '[TANGGAL LAHIR TIDAK DITEMUKAN]'); ?></td>
                </tr>
                <tr>
                    <td class="label">Jenis Kelamin</td>
                    <td class="separator">:</td>
                    <td><?php echo e($permohonan->masyarakat->jenis_kelamin ?? '[JENIS KELAMIN TIDAK DITEMUKAN]'); ?></td>
                </tr>
                 <tr>
                    <td class="label">Pekerjaan</td>
                    <td class="separator">:</td>
                    <td><?php echo e($permohonan->masyarakat->pekerjaan ?? '[PEKERJAAN TIDAK DITEMUKAN]'); ?></td>
                </tr>
                <tr>
                    <td class="label">Alamat</td>
                    <td class="separator">:</td>
                    <td><?php echo e($permohonan->masyarakat->alamat_lengkap ?? '[ALAMAT TIDAK DITEMUKAN]'); ?></td>
                </tr>
            </table>
            ...
            <?php echo $permohonan->konten_final_html; ?>
...
<?php /**PATH C:\PA\desa_kumantan\desa_kumantan\resources\views/documents/surat_lainnya.blade.php ENDPATH**/ ?>