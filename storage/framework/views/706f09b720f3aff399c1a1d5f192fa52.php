...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?php echo e(route('petugas.permohonan-sk-perkawinan.index')); ?>" class="btn btn-secondary btn-sm">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-4">Tempat, Tgl Lahir</dt><dd class="col-sm-8"><?php echo e($permohonan->tempat_lahir_pria ?? '-'); ?>, <?php echo e($permohonan->tanggal_lahir_pria ? \Carbon\Carbon::parse($permohonan->tanggal_lahir_pria)->isoFormat('D MMMM YYYY') : '-'); ?></dd>
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-4">Tempat, Tgl Lahir</dt><dd class="col-sm-8"><?php echo e($permohonan->tempat_lahir_wanita ?? '-'); ?>, <?php echo e($permohonan->tanggal_lahir_wanita ? \Carbon\Carbon::parse($permohonan->tanggal_lahir_wanita)->isoFormat('D MMMM YYYY') : '-'); ?></dd>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <?php elseif($permohonan->status == 'diterima'): ?>
                    ...
                    <a href="<?php echo e(route('petugas.permohonan-sk-perkawinan.edit-surat', $permohonan->id)); ?>" class="btn btn-primary btn-block mb-2"><i class="fas fa-edit"></i> Proses & Edit Surat</a>
                ...
                <?php elseif($permohonan->status == 'selesai'): ?>
                    ...
                    <a href="<?php echo e(route('petugas.permohonan-sk-perkawinan.download-final', $permohonan->id)); ?>" class="btn btn-success btn-block"><i class="fas fa-download"></i> Unduh Dokumen Final</a>
            ...
            <form action="<?php echo e(route('petugas.permohonan-sk-perkawinan.tolak', $permohonan->id)); ?>" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="catatan_penolakan" rows="4" required placeholder="Contoh: Scan KTP mempelai wanita buram, mohon unggah ulang."></textarea>
