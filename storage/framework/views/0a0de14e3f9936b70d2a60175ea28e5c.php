        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <dl class="row mt-3">
                    ...
                    <dt class="col-sm-4">No. Buku Nikah</dt><dd class="col-sm-8"><?php echo e($permohonan->no_buku_nikah ?? '-'); ?></dd>
                </dl>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <?php elseif($permohonan->status == 'diterima'): ?>
                    ...
                    <form action="<?php echo e(route('petugas.permohonan-sk-kelahiran.selesaikan', $permohonan->id)); ?>" method="POST" class="mb-2">
                        <?php echo csrf_field(); ?>
