        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-4">Tempat / Tanggal Lahir</dt><dd class="col-sm-8"><?php echo e($permohonan->tempat_lahir_pewaris ?? '-'); ?>, <?php echo e($permohonan->tanggal_lahir_pewaris ? $permohonan->tanggal_lahir_pewaris->format('d F Y') : '-'); ?></dd>
                    <dt class="col-sm-4">Tanggal Meninggal</dt><dd class="col-sm-8"><?php echo e($permohonan->tanggal_meninggal_pewaris ? $permohonan->tanggal_meninggal_pewaris->format('d F Y') : '-'); ?></dd>
                ...
                <?php if(!empty($permohonan->daftar_ahli_waris)): ?>
                    <table class="table table-bordered table-sm mt-3">
                        <thead><tr><th>Nama</th><th>NIK</th><th>Hubungan</th><th>Alamat</th></tr></thead>
                        <tbody>
                            <?php $__currentLoopData = $permohonan->daftar_ahli_waris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ahli): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
            ...
            <div class="card-body">
                ...
                <?php elseif(in_array($permohonan->status, ['diterima', 'diproses'])): ?>
                    <p>Permohonan diverifikasi. Klik tombol di bawah untuk membuat surat secara otomatis.</p>
                     <form action="<?php echo e(route('petugas.permohonan-sk-ahli-waris.selesaikan', $permohonan->id)); ?>" method="POST" class="mb-2">
                        <?php echo csrf_field(); ?>
