...
<?php $__env->startSection('title', 'Detail & Proses Permohonan KK Hilang'); ?>

<?php $__env->startSection('content'); ?>
<h1 class="h3 mb-4 text-gray-800">Detail Permohonan KK Hilang #<?php echo e($permohonan->id); ?></h1>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <?php if($permohonan->status == 'pending'): ?>
                    ...
                    <form action="<?php echo e(route('petugas.permohonan-kk-hilang.verifikasi', $permohonan->id)); ?>" method="POST" class="mb-2">
                        <?php echo csrf_field(); ?>
                ...
                <?php elseif(in_array($permohonan->status, ['diterima', 'diproses'])): ?>
                    <p>Permohonan telah diverifikasi. Unggah file KK pengganti untuk menyelesaikan proses.</p>
                ...
                <?php elseif($permohonan->status == 'selesai'): ?>
                    ...
                    <a href="<?php echo e(route('petugas.permohonan-kk-hilang.download-final', $permohonan->id)); ?>" class="btn btn-success btn-block"><i class="fas fa-download"></i> Unduh KK Final</a>
                ...
                <a href="<?php echo e(route('petugas.permohonan-kk-hilang.index')); ?>" class="btn btn-secondary btn-block mt-3"><i class="fas fa-arrow-left"></i> Kembali ke Daftar</a>
            </div>
        </div>
...
<div class="modal fade" id="tolakModal" tabindex="-1" role="dialog" aria-labelledby="tolakModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('petugas.permohonan-kk-hilang.tolak', $permohonan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="selesaikanModal" tabindex="-1" role="dialog" aria-labelledby="selesaikanModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('petugas.permohonan-kk-hilang.selesaikan', $permohonan->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
                    <h5 class="modal-title" id="selesaikanModalLabel">Unggah KK Pengganti</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="file_hasil_akhir">Pilih File PDF KK Pengganti:</label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA\desa_kumantan\desa_kumantan\resources\views/petugas/pengajuan/kk_hilang/show.blade.php ENDPATH**/ ?>