...
<?php $__env->startSection('title', 'Detail & Proses Permohonan Perubahan Data KK'); ?>

<?php $__env->startSection('content'); ?>
<h1 class="h3 mb-4 text-gray-800">Detail Permohonan Perubahan Data KK #<?php echo e($permohonan->id); ?></h1>
...
<div class="row">
    ...
    <div class="col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <dl class="row">
                    <dt class="col-sm-4">Nama Pemohon</dt><dd class="col-sm-8"><?php echo e($permohonan->masyarakat->nama_lengkap ?? 'N/A'); ?></dd>
                    <dt class="col-sm-4">NIK Pemohon</dt><dd class="col-sm-8"><?php echo e($permohonan->masyarakat->nik ?? 'N/A'); ?></dd>
                    <dt class="col-sm-4">Tanggal Pengajuan</dt><dd class="col-sm-8"><?php echo e($permohonan->created_at->format('d F Y, H:i')); ?></dd>
                </dl>
                <hr>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <?php if($permohonan->status == 'pending'): ?>
                    ...
                    <form action="<?php echo e(route('petugas.permohonan-kk-perubahan.verifikasi', $permohonan->id)); ?>" method="POST" class="mb-2">
                        <?php echo csrf_field(); ?>
                ...
                <?php elseif($permohonan->status == 'selesai'): ?>
                    ...
                    <a href="<?php echo e(route('petugas.permohonan-kk-perubahan.download-final', $permohonan->id)); ?>" class="btn btn-success btn-block"><i class="fas fa-download"></i> Unduh KK Final</a>
                ...
                <a href="<?php echo e(route('petugas.permohonan-kk-perubahan.index')); ?>" class="btn btn-secondary btn-block mt-3"><i class="fas fa-arrow-left"></i> Kembali ke Daftar</a>
            </div>
        </div>
...
<div class="modal fade" id="tolakModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('petugas.permohonan-kk-perubahan.tolak', $permohonan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="selesaikanModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('petugas.permohonan-kk-perubahan.selesaikan', $permohonan->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA\desa_kumantan\desa_kumantan\resources\views/petugas/pengajuan/kk_perubahan/show.blade.php ENDPATH**/ ?>