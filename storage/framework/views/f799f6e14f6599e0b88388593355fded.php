...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?php echo e(route('petugas.permohonan-kk-perubahan.index')); ?>" class="btn btn-secondary btn-sm">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div>
                            <i class="fas fa-file-alt text-gray-500 mr-2"></i> <?php echo e($label); ?>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <?php elseif($permohonan->status == 'selesai'): ?>
                    ...
                    <a href="<?php echo e(route('petugas.permohonan-kk-perubahan.download-final', $permohonan->id)); ?>" class="btn btn-success btn-block"><i class="fas fa-download"></i> Unduh Dokumen Final</a>
