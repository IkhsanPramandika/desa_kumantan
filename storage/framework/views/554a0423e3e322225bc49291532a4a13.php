...
<h1 class="h3 mb-4 text-gray-800">Detail Permohonan Surat Keterangan Usaha #<?php echo e($permohonan->id); ?></h1>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <dl class="row">
                    ...
                    <dt class="col-sm-4">Tempat, Tgl Lahir</dt><dd class="col-sm-8"><?php echo e($permohonan->tempat_lahir ?? '-'); ?>, <?php echo e($permohonan->tanggal_lahir ? $permohonan->tanggal_lahir->format('d F Y') : '-'); ?></dd>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <?php elseif($permohonan->status == 'selesai'): ?>
                    ...
                    <a href="<?php echo e(route('petugas.permohonan-sk-usaha.download-final', $permohonan->id)); ?>" class="btn btn-success btn-block"><i class="fas fa-download"></i> Unduh Surat</a>
                ...
                <a href="<?php echo e(route('petugas.permohonan-sk-usaha.index')); ?>" class="btn btn-secondary btn-block mt-3"><i class="fas fa-arrow-left"></i> Kembali ke Daftar</a>
            </div>
        </div>
