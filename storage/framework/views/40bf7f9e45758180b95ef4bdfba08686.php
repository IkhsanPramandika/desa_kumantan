...
<?php $__env->startSection('title', 'Detail Permohonan SK Domisili'); ?>

<?php $__env->startSection('content'); ?>
<h1 class="h3 mb-4 text-gray-800">Detail Permohonan Surat Keterangan Domisili #<?php echo e($permohonan->id); ?></h1>
    ...
    <div class="col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <dl class="row">
                    <dt class="col-sm-4">Nama</dt><dd class="col-sm-8"><?php echo e($permohonan->nama_pemohon_atau_lembaga ?? '-'); ?></dd>
                ...
                <dl class="row">
                    <dt class="col-sm-4">Alamat Lengkap</dt><dd class="col-sm-8"><?php echo e($permohonan->alamat_lengkap_domisili ?? '-'); ?></dd>
                    <dt class="col-sm-4">RT / RW / Dusun</dt><dd class="col-sm-8"><?php echo e($permohonan->rt_domisili ?? '-'); ?> / <?php echo e($permohonan->rw_domisili ?? '-'); ?> / <?php echo e($permohonan->dusun_domisili ?? '-'); ?></dd>
                    <dt class="col-sm-4">Keperluan</dt><dd class="col-sm-8"><?php echo e($permohonan->keperluan_domisili ?? '-'); ?></dd>
                </dl>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <?php if($permohonan->status == 'pending'): ?>
                    ...
                    <form action="<?php echo e(route('petugas.permohonan-sk-domisili.verifikasi', $permohonan->id)); ?>" method="POST" class="mb-2">
                        <?php echo csrf_field(); ?>
                ...
                <?php elseif($permohonan->status == 'selesai'): ?>
                    ...
                    <a href="<?php echo e(route('petugas.permohonan-sk-domisili.download-final', $permohonan->id)); ?>" class="btn btn-success btn-block mb-2"><i class="fas fa-download"></i> Unduh Surat (Petugas)</a>
                    <div class="form-group">
                        <label>Link Download Publik:</label>
                        <div class="input-group">
                            <input type="text" class="form-control" value="<?php echo e(route('public.download.sk-domisili', $permohonan->id)); ?>" readonly id="publicLink">
                ...
                <a href="<?php echo e(route('petugas.permohonan-sk-domisili.index')); ?>" class="btn btn-secondary btn-block mt-3"><i class="fas fa-arrow-left"></i> Kembali ke Daftar</a>
            </div>
        </div>
...
<div class="modal fade" id="tolakModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('petugas.permohonan-sk-domisili.tolak', $permohonan->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA\desa_kumantan\desa_kumantan\resources\views/petugas/pengajuan/sk_domisili/show.blade.php ENDPATH**/ ?>