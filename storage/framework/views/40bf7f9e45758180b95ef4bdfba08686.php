...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?php echo e(route('petugas.permohonan-sk-domisili.index')); ?>" class="btn btn-secondary btn-sm">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <dl class="row">
                    ...
                    <dd class="col-sm-7 font-weight-bold"><?php echo e($permohonan->nama_pemohon_atau_lembaga ?? '-'); ?></dd>
                    
                    <dt class="col-sm-5">NIK Pemohon</dt>
                    <dd class="col-sm-7"><?php echo e($permohonan->nik_pemohon ?? '-'); ?></dd>
                    
                    <dt class="col-sm-5">Alamat Domisili</dt>
                    <dd class="col-sm-7"><?php echo e($permohonan->alamat_lengkap_domisili ?? '-'); ?></dd>

                    <dt class="col-sm-5">RT/RW</dt>
                    <dd class="col-sm-7"><?php echo e($permohonan->rt_domisili ?? '-'); ?> / <?php echo e($permohonan->rw_domisili ?? '-'); ?></dd>

                    <dt class="col-sm-5">Keperluan</dt>
                    <dd class="col-sm-7"><?php echo e($permohonan->keperluan_domisili ?? '-'); ?></dd>
                </dl>
            </div>
        </div>
    </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <?php elseif($permohonan->status == 'diterima'): ?>
                    ...
                    <a href="<?php echo e(route('petugas.permohonan-sk-domisili.edit-surat', $permohonan->id)); ?>" class="btn btn-primary btn-block mb-2"><i class="fas fa-edit"></i> Proses & Edit Surat</a>
                ...
                <?php elseif($permohonan->status == 'selesai'): ?>
                    ...
                    <a href="<?php echo e(route('petugas.permohonan-sk-domisili.download-final', $permohonan->id)); ?>" class="btn btn-success btn-block"><i class="fas fa-download"></i> Unduh Dokumen Final</a>
