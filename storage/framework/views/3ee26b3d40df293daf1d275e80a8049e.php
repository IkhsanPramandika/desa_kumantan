...
<?php $__env->startSection('title', 'Daftar Permohonan Perubahan Data KK'); ?>

<?php $__env->startSection('content'); ?>
<h1 class="h3 mb-4 text-gray-800">Daftar Permohonan Perubahan Data KK</h1>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="card card-body mb-4 p-3 bg-light">
            <form action="<?php echo e(route('petugas.permohonan-kk-perubahan.index')); ?>" method="GET">
                <div class="row align-items-end">
                    <div class="col-md-4">
                        <label for="search" class="font-weight-bold">Cari Nama/NIK</label>
                        <input type="text" class="form-control" id="search" name="search" placeholder="Masukkan nama atau NIK..." value="<?php echo e(request('search')); ?>">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex mt-3 mt-md-0">
                        ...
                        <a href="<?php echo e(route('petugas.permohonan-kk-perubahan.index')); ?>" class="btn btn-secondary ml-2" title="Reset Filter"><i class="fas fa-sync"></i></a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('petugas.permohonan-kk-perubahan.show', $item->id)); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PA\desa_kumantan\desa_kumantan\resources\views/petugas/pengajuan/kk_perubahan/index.blade.php ENDPATH**/ ?>