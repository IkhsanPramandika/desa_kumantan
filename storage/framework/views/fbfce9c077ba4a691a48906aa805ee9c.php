                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($overallTotalRejected ?? 0); ?></div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <a href="<?php echo e(route($details['route'])); ?>" class="card-link">
                                ...
                                <div class="card border-left-<?php echo e($colorClass); ?> shadow-sm h-100">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="icon-circle bg-<?php echo e($colorClass); ?> mr-3">
                                                <i class="<?php echo e($details['icon']); ?>"></i>
                                            </div>
                                            <div>
                                                <h6 class="font-weight-bold mb-0 text-<?php echo e($colorClass); ?>"><?php echo e($details['title']); ?></h6>
                                                <small class="text-muted"><?php echo e($stats[$key]['total'] ?? 0); ?> Permohonan Diajukan</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        data: {
            ...
            datasets: [{
                data: [
                    ...
                    <?php echo e($overallTotalRejected ?? 0); ?>
