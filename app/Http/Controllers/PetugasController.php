    ...
    public function dashboard()
{
    ...
    $permohonanModels = [
        'kkBaru'          => \App\Models\PermohonananKKBaru::class,
        'kkHilang'        => \App\Models\PermohonananKKHilang::class,
        'kkPerubahanData' => \App\Models\PermohonananKKPerubahanData::class,
        'skDomisili'      => \App\Models\PermohonananSKDomisili::class,
        'skKelahiran'     => \App\Models\PermohonananSKKelahiran::class,
        'skPerkawinan'    => \App\Models\PermohonananSKPerkawinan::class,
        'skTidakMampu'    => \App\Models\PermohonananSKTidakMampu::class,
        'skUsaha'         => \App\Models\PermohonananSKUsaha::class,
        'skAhliWaris'     => \App\Models\PermohonananSKAhliWaris::class,
    ];
