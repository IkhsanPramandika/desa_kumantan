...
use App\Models\PermohonananKKHilang; // Pastikan nama model sudah benar
...
class PermohonanKKHilangController extends Controller
{
    ...
    {
        $query = PermohonananKKHilang::with('masyarakat')->latest();
    ...
    {
        $permohonan = PermohonananKKHilang::with('masyarakat')->findOrFail($id);
