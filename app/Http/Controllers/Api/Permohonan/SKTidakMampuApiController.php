    ...
    public function store(StoreSKTidakMampuRequest $request): JsonResponse
    {
        ...
        try {
            ...
            if ($request->has('revisi_id') && !empty($request->revisi_id)) {
                // ALUR REVISI
                $permohonan = PermohonanSKTidakMampu::where('id', $request->revisi_id)
            ...
            if (isset($permohonan)) {
                ...
                $message = 'Revisi permohonan SKTM berhasil dikirim.';
            } else {
                $permohonan = PermohonanSKTidakMampu::create($dbData);
                $message = 'Permohonan SKTM berhasil diajukan.';
            }
            ...
            if ($semuaPetugas->isNotEmpty()) {
                ...
                // Jika revisi, ubah sedikit pesannya
            ...
            Log::error('[API SKTM - Store/Revisi] Gagal menyimpan: ' . $e->getMessage());
