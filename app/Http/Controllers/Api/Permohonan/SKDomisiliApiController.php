    ...
    public function store(StoreSKDomisiliRequest $request): JsonResponse
    {
        ...
        try {
            ...
            if ($request->has('revisi_id') && !empty($request->revisi_id)) {
                // ALUR REVISI
                $permohonan = PermohonanSKDomisili::where('id', $request->revisi_id)
            ...
            if (isset($permohonan)) {
                ...
                $message = 'Revisi permohonan SK Domisili berhasil dikirim.';
            } else {
                $permohonan = PermohonanSKDomisili::create($dbData);
                $message = 'Permohonan SK Domisili berhasil diajukan.';
            }
            ...
            Log::error('[API SK Domisili - Store/Revisi] Gagal menyimpan: ' . $e->getMessage());
